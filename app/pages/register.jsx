                        ...
                        <form>
                            <div className="flex flex-col mb-6">
                                ...
                                <div className="relative">
                                    ...
                                    <input onChange={"value"} required id="name" type="text" name="name" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-orange-400" placeholder="Name" />
                                </div>
                            </div>
                            <div className="flex flex-col mb-6">
                                ...
                                <div className="relative">
                                    ...
                                    <input onChange={"value"} required id="email" type="email" name="email" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-orange-400" placeholder="E-Mail Address" />
                                </div>
                            </div>
                            <div className="flex flex-col mb-6">
                                ...
                                <div className="relative">
                                    ...
                                    <input onChange={"value"} required id="password" type="password" name="password" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-orange-400" placeholder="Password" />
                                         ...
                                         <p className="text-red-500 text-xs italic">Please choose a password of at least 8 characters.</p>
